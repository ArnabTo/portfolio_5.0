...
export const LampContainer = ({children, className}) => {
  return (
    <div
      className={cn(
        "relative flex min-h-screen lg:h-[130vh] xl:h-[100vh] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      ...
      <div className="relative top-80 lg:top-52 z-50 flex -translate-y-80 flex-col items-center px-5 py-10">
        {children}
      </div>
    </div>
  );
