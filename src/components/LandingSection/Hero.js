    ...
    return (
      ...
      <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
        ...
        <div className='text-2xl md:text-5xl text-center font-bold my-2 md:my-5 bg-clip-text '>
          ...
          <button onClick={downlaodResume} className="relative flex m-auto h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
